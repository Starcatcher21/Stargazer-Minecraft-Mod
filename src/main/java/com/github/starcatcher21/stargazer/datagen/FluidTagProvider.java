...
public class FluidTagProvider extends FabricTagsProvider.FluidTagsProvider {
    public FluidTagProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
