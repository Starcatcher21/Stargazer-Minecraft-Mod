...
public class StarLeavesEntityRenderer<T extends StarLeavesEntity> implements BlockEntityRenderer<T, StarLeavesBlockEntityRenderState> {
    public StarLeavesEntityRenderer(BlockEntityRendererProvider.Context ctx) {
    }
    ...
    @Override
    public StarLeavesBlockEntityRenderState createRenderState() {
        return new StarLeavesBlockEntityRenderState();
    }

    @Override
    public void submit(StarLeavesBlockEntityRenderState state, PoseStack matrices, SubmitNodeCollector queue, CameraRenderState cameraState) {
