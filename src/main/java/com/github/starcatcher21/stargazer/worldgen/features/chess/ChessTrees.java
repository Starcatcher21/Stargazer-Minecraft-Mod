...
public class ChessTrees extends Feature<TreeConfig> {
    ...
    public static Tree register(String name) {
        Tree tree = new Tree(false, name, Chess.WHITE_CHESSBOARD.defaultBlockState(), Chess.WHITE_CHESSBOARD.defaultBlockState());
        TREELIST.add(tree);
        return tree;
    }

    public static Tree registerBlack(String name) {
        Tree tree = new Tree(false, name, Chess.BLACK_CHESSBOARD.defaultBlockState(), Chess.BLACK_CHESSBOARD.defaultBlockState());
        TREELIST.add(tree);
        return tree;
    }
