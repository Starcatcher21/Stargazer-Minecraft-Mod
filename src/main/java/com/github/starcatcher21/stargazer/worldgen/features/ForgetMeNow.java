...
public class ForgetMeNow extends Feature<NoneFeatureConfiguration> {
    public ForgetMeNow(Codec<NoneFeatureConfiguration> codec) {
        super(codec);
    }
    ...
    private BlockState getState() {
        ...
        BlockState forgor = MoonBlocks.FORGET_ME_NOW.defaultBlockState().setValue(FlowerBedBlock.FACING, direction).setValue(FlowerBedBlock.AMOUNT, rand.nextInt(1,4));
        return forgor;
    }
