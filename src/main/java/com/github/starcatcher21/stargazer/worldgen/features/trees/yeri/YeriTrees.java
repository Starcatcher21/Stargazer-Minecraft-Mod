...
public class YeriTrees extends Feature<TreeConfig> {
    ...
    public static Tree treeSmall = register("yeriSmall");

    public YeriTrees(Codec<TreeConfig> configCodec) {
        super(configCodec);
    }

    public static Tree register(String name) {
        Tree tre = new Tree(true, name, RedOrbBlocks.YERI_LOG.defaultBlockState(), RedOrbBlocks.YERI_LEAVES.defaultBlockState());
        TREELIST.add(tre);
        return tre;
    }

    public static void init() {
        YeriTree.init(treeSmall);
    }
