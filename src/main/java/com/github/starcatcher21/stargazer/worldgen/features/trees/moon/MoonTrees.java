package com.github.starcatcher21.stargazer.worldgen.features.trees.moon;
...
public class MoonTrees extends Feature<TreeConfig> {
    ...
    public static Tree register(String name) {
        Tree tree = new Tree(true, name, MoonBlocks.MOON_LOG.defaultBlockState().setValue(BlockStateProperties.AXIS, Direction.Axis.Y), MoonBlocks.MOON_LEAVES.defaultBlockState());
        tree.addFruit(MoonBlocks.GEODE_FRUIT.defaultBlockState().setValue(GeodeFruit.STAGE, GeodeFruitStage.grown).setValue(GeodeFruit.FACING, Direction.NORTH));
        tree.addFruit(MoonBlocks.GEODE_FRUIT.defaultBlockState().setValue(GeodeFruit.STAGE, GeodeFruitStage.grown).setValue(GeodeFruit.FACING, Direction.SOUTH));
        tree.addFruit(MoonBlocks.GEODE_FRUIT.defaultBlockState().setValue(GeodeFruit.STAGE, GeodeFruitStage.grown).setValue(GeodeFruit.FACING, Direction.WEST));
        tree.addFruit(MoonBlocks.GEODE_FRUIT.defaultBlockState().setValue(GeodeFruit.STAGE, GeodeFruitStage.grown).setValue(GeodeFruit.FACING, Direction.EAST));
