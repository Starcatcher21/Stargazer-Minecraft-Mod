...
public class DarknessTrees extends Feature<TreeConfig> {
    ...
    public static Tree register(String name) {
        Tree tree = new Tree(true, name, Darkness.LOG_OF_DARKNESS.defaultBlockState().setValue(BlockStateProperties.AXIS, Direction.Axis.Y), Darkness.DARKNESS_LEAVES.defaultBlockState());
        TREELIST.add(tree);
        return tree;
    }
