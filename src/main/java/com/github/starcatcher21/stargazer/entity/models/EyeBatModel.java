...
public class EyeBatModel extends GeoModel<EyeBat> {
    private final Identifier model = Identifier.of(Stargazer.MOD_ID, "entity/eye_bat");
    private final Identifier animations = Identifier.of(Stargazer.MOD_ID, "entity/eye_bat");
