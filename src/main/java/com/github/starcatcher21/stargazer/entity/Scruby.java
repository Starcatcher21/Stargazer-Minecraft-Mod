...
public class Scruby extends TamableAnimal implements GeoEntity {
    protected static final RawAnimation WALK_ANIM = RawAnimation.begin().thenLoop("walk");
    protected static final RawAnimation LOOK_ANIM = RawAnimation.begin().thenLoop("look");

    private final AnimatableInstanceCache geoCache = GeckoLibUtil.createInstanceCache(this);

    public Scruby(EntityType<? extends Scruby> type, Level world) {
        super(type, world);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new TamableAnimal.TamableAnimalPanicGoal(2.0d));
    }
