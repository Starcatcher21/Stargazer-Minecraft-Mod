...
public class BlackRook extends PathfinderMob implements GeoEntity {
    private final AnimatableInstanceCache geoCache = GeckoLibUtil.createInstanceCache(this);

    public BlackRook(EntityType<? extends BlackRook> type, Level world) {
        super(type, world);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new NearestAttackableTargetGoal<Rook>(this, Rook.class, true));
