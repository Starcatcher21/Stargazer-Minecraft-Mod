...
public class StarGeneratorScreenHandler extends AbstractContainerMenu {

    private final Player player;
    private final ContainerData propertyDelegate;
    private final Container blockInventory;

    public StarGeneratorScreenHandler(int syncId, Inventory playerInventory) {
        this(syncId, playerInventory, new SimpleContainer(2), new SimpleContainerData(4));
    }

    public StarGeneratorScreenHandler(int syncId, Inventory inventory, BlockPos pos) {
        this(syncId, inventory,
                inventory.player.level().getBlockEntity(pos) instanceof Container inv ? inv : new SimpleContainer(2),
    ...
    public StarGeneratorScreenHandler(int syncId, Inventory playerInventory,
        ...
        this.addSlot(new Slot(blockInventory, 0, 48, 13) {
             ...
             public boolean mayPlace(ItemStack stack) {
                 return stack.is(CustomTags.STAR); // Crucial: This completely blocks normal manual item insertion
             }
        });
        // Slot 1 (e.g., Output)
