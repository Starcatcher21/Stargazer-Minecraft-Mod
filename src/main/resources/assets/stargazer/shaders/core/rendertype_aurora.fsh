...
#define SWIRL_INTENSITY   2.0

#define MASTER_BRIGHTNESS 0.55
#define HIGHLIGHT_SHEEN   0.45
#define EMISSIVE_FLOOR    0.35

#define HUE_MIN           0.15
#define HUE_MAX           0.70
#define COLOR_CYCLE_SPEED 0.015

#define SCANLINE_DENSITY  500.0
#define SCANLINE_DARKNESS 0.06
