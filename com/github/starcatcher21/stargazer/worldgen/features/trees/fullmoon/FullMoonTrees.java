...
public class FullMoonTrees extends Feature<TreeConfig> {
    ...
    public static Tree register(String name) {
        Tree tree = new Tree(true, name, MoonBlocks.FULL_MOON_LOG.getDefaultState().with(Properties.AXIS, Direction.Axis.Y), MoonBlocks.FULL_MOON_LEAVES.getDefaultState());
        tree.addFruit(MoonBlocks.FULL_MOON_CORE.getDefaultState());
