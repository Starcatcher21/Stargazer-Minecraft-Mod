package com.github.starcatcher21.stargazer.mechanics.star.mechanics.advancements;
...
public class Criterias {
    ...
    public static final StarModifier starModifier = Criteria.register(Identifier.of(Stargazer.MOD_ID, "star_modifier").toString(), new StarModifier());
