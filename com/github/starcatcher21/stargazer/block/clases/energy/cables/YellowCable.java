...
public class YellowCable extends BlockWithEntity {
    public static final MapCodec<YellowCable> CODEC = Block.createCodec(YellowCable::new);
    ...
    private static final Map<Direction, VoxelShape> DIRECTION_SHAPES = bhs.a(new HashMap<>(), map -> {
    ...
    public YellowCable(Settings settings) {
        super(settings);
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new YellowCableEntity(pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return validateTicker(type, BlockTypes.YELLOW_CABLE, YellowCableEntity::tick);
    }
}