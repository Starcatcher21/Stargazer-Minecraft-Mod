...
public class BlueCable extends BlockWithEntity {
    public static final MapCodec<BlueCable> CODEC = Block.createCodec(BlueCable::new);
    ...
    public BlueCable(Settings settings) {
        super(settings);
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new BlueCableEntity(pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return validateTicker(type, BlockTypes.BLUE_CABLE, BlueCableEntity::tick);
    }
}