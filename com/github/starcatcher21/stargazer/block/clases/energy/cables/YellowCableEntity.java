...
public class YellowCableEntity extends BlockEntity implements EnergyStorage {
	public YellowCableEntity(BlockPos pos, BlockState state) {
		super(BlockTypes.YELLOW_CABLE, pos, state);
	}

	public final SimpleEnergyStorage energyStorage = new SimpleEnergyStorage(1000, 1000, 1000) {
		@Override
	...
	public static void tick(World world, BlockPos pos, BlockState state, YellowCableEntity blockEntity) {
		...
		for (Direction direction : Direction.values()) {
			...
			if (targetStorage != null && targetStorage.supportsInsertion()) {
				...
				long maxToMove;
				if (world.getBlockEntity(targetPos) instanceof YellowCableEntity neighborCable) {
