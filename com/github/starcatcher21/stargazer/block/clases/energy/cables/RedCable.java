...
public class RedCable extends BlockWithEntity {
    public static final MapCodec<RedCable> CODEC = Block.createCodec(RedCable::new);
    ...
    public RedCable(Settings settings) {
        super(settings);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return validateTicker(type, BlockTypes.RED_CABLE, RedCableEntity::tick);
    }
}