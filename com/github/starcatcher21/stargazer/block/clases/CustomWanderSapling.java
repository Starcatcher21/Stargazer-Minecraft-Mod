...
public class CustomWanderSapling extends PlantBlock implements Fertilizable {
    ...
    public CustomWanderSapling(RegistryKey<ConfiguredFeature<?, ?>> featureKey, Settings settings) {
        super(settings);
