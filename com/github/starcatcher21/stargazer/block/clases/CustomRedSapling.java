...
public class CustomRedSapling extends PlantBlock implements Fertilizable {
    ...
    public CustomRedSapling(RegistryKey<ConfiguredFeature<?, ?>> featureKey, Settings settings) {
        super(settings);
